...
impl StackLayouter {
    ...
    pub fn layout(&self) {
        match self.align {
            Align::Start => println!("Left aligned"),
            Align::Center => println!("Center aligned"),
            Align::End => println!("Right aligned"),
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_layout_start() {
        let layouter = StackLayouter::new(Align::Start);
        layouter.layout();  // "Left aligned"が出力されることを確認
    }

    #[test]
    fn test_layout_center() {
        let layouter = StackLayouter::new(Align::Center);
        layouter.layout();  // "Center aligned"が出力されることを確認
    }

    #[test]
    fn test_layout_end() {
        let layouter = StackLayouter::new(Align::End);
        layouter.layout();  // "Right aligned"が出力されることを確認
    }
}
